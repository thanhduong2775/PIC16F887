...
{
   int8 xl;
   if((xu_ly_chay==0&&cht==0)||(xu_ly_chay1==0&&cht==1))
   {
      for(xl=6;xl>0;xl--)
      {
   ...
   if((xu_ly_chay==1&&cht==0)||(xu_ly_chay1==1&&cht==1))
   {
      for(xl=6;xl>0;xl--)
      {
         lcd_gotoxy(1,2); // dua con tro LCD ve dong 1 cot 1;
...
void tao_tre2(int16 t)
{
   ...
   for(i=0;i<t;i++)
   {
      ...
      doc_cam_bien();
      kiem_tra();
      if((canh_bao==0&&cht==0)||(canh_bao1==0&&cht==1)) break;
   }
}
//======================================== 
void tao_tre(int16 t)
{
   ...
   for(i=0;i<t;i++)
   {
      ...
      doc_cam_bien();
      kiem_tra();
      if(canh_bao==1||canh_bao1==1) break;
   }
}
//======================================== 
void doc_cam_bien()
{
   ...
   nhiet=chuen_doi_nhiet_ntc(nhiet);
   set_adc_channel(1); // chon kenh an0
   nhiet1=1023-read_adc_lap(); // doc gia tri tu kenh an0
   nhiet1=chuen_doi_nhiet_ntc(nhiet1);
}
//======================================== 
#define nn1 pin_c4
#define nn2 pin_D3
